...
public class EmployeeValidator {
     ...
     * @param ev EmloyeeServiceのインスタンス
     * @param codeDuplicateCheckFlag 社員番号の重複チェックを実施するかどうか（true or false）
     * @param passwordCheckFlag パスワードの入力チェックをするかどうか（true or false）
     * @return エラーのリスト
     */
     ...
     * @param passwordCheckFlag パスワードの入力チェックを実施するかどうか（true or false）
     * @return エラーメッセージ
     */
